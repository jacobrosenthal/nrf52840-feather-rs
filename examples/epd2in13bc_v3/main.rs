...
//! skip 2
//!
//! DEFMT_LOG=trace cargo run --release --example epd2in13bc_v3
#![no_main]
#![no_std]
...
pub async fn display_task() {
    ...
    // let mut busy = gpio::Flex::new(dp.P0_06.degrade())
    //     .set_as_input_output(gpio::Pull::Up, gpio::OutputDrive::Standard0Disconnect1);
    ...
    // let mut buffer = [255u8; WIDTH as usize * HEIGHT as usize / 8];
